...
//     version 1.11.2
//     from Assets/_programming/_input/'InputActions.inputactions
//
...
public partial class @InputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@InputActions()
    {
        UnityEngine.Debug.Assert(!m_Adaptive_Controller_GamePad.enabled, "This will cause a leak and performance issues, InputActions.Adaptive_Controller_GamePad.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Adaptive_Controller_Xbox.enabled, "This will cause a leak and performance issues, InputActions.Adaptive_Controller_Xbox.Disable() has not been called.");
    }
    ...
    public struct Adaptive_Controller_GamePadActions
    {
        ...
        public Adaptive_Controller_GamePadActions(@InputActions wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @InputActions m_Wrapper;
        public Adaptive_Controller_XboxActions(@InputActions wrapper) { m_Wrapper = wrapper; }
